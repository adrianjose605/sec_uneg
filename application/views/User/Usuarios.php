                            ...
                            <form class="form-inline" name="formNoticiaM" role="form" novalidate>
                                ...
                                <div class="form-group">
                                    <md-input-container flex>
                                        ...
                                        <input ng-model="alerta_nueva.ubicacion"  ng-readonly="true" pattern="^[a-zA-Z0-9áéíóúñ_]+( [a-zA-Z0-9áéíóúñ _]+)*$" name="ubicacion_noticia" type="text">
                                ...
                                <img data-ng-src="{{alerta_nueva.foto}}"  style="max-width: 640px; max-height: 480px"  data-err-src="<?php echo base_url(); ?>public/img/angular.png"/>
                                </div>
